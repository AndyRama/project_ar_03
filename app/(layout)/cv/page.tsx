...
const experiences = [
  {
    ...
    tasks: [
      "Site vitrine pour un menuisier de Mérignac, pensé pour transformer les visites en demandes de devis",
      "Cahier des charges défini en direct avec l'artisan, à partir de ses chantiers réels",
      "Maquettage de l'interface sur Figma, puis développement full-stack de A à Z",
      "Blog optimisé SEO pour renforcer la visibilité locale sur les recherches de rénovation",
      "Mise en production et ajustements réguliers suite aux retours du client",
    ],
  },
  {
    company: "Segment.C",
    ...
    tasks: [
      "Site vitrine pour Segment.C, entreprise de menuiserie à Saint-Jean-d'Illac",
      "Catalogue de réalisations structuré par type de prestation (portes, fenêtres, pergolas)",
      "Design et prototypage sur Figma en collaboration avec le client",
      "Développement complet de la solution et intégration d'un blog pour le SEO local",
      "Utilisation d'outils IA pour accélérer la rédaction de contenu et le suivi du projet",
    ],
  },
  {
    ...
    tasks: [
      "Conception du portfolio personnel pour présenter mes projets et compétences",
      "Création de l'identité visuelle et prototypage de l'interface",
      "Déploiement en production et maintenance continue (Coolify + VPS)",
    ],
  },
  {
    company: "Unlcoaching",
    ...
    tasks: [
      "Plateforme web pour un coach sportif à Bordeaux, avec espace client sécurisé",
      "Analyse des besoins du client et rédaction du cahier des charges",
      "Design responsive pensé pour guider le sportif vers son programme personnalisé",
      "Développement complet de la solution, du back-end à l'interface",
      "Déploiement, optimisation des performances et maintenance",
    ],
  },
  {
    ...
    tasks: [
      "Site web pour une entreprise de plomberie disponible 24h/24, conçu pour rassurer en urgence",
      "Cahier des charges orienté conversion : tarifs et contact visibles en un coup d'œil",
      "Design et maquettage de l'interface, priorité à la rapidité de navigation mobile",
      "Optimisation SEO local pour capter les recherches d'urgence dans la région",
      "Support technique et maintenance régulière post-lancement",
    ],
  },
  {
    company: "I-doctor",
    ...
    tasks: [
      "Assistant IA qui répond au téléphone et prend les rendez-vous médicaux à la place du secrétariat",
      "Gestion de planning optimisée pour libérer du temps aux praticiens",
      "Architecture SaaS : Next.js, PostgreSQL, NextAuth, Stripe, TypeScript",
    ],
  },
];
...
const otherProjects = [
  {
    ...
    tasks: [
      "Plateforme showcase pour accompagner des entreprises dans l'intégration d'agents IA (Claude, Ollama...)",
      "Définition du périmètre fonctionnel : formation, cas d'usage, démonstrations",
      "Conception de l'interface pour rendre des concepts IA accessibles à un public non technique",
      "Déploiement progressif avec ajout continu de nouveaux contenus",
    ],
  },
  {
    ...
    tasks: [
      "Création de sites et SEO local dédiée aux artisans et indépendants",
      "Modèle au lead partagé, pensé pour convertir la visibilité Google en rendez-vous qualifiés",
      "Conception de l'interface et du parcours client, du premier contact à la signature",
      "Mise en place du suivi Google Business Profile et de la stratégie de contenu",
    ],
  },
];
